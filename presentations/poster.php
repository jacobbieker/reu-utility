...
?>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Upload your Symposium Poster</h1>
    	<p>Upload your poster by using the form below. The accepted formats are <i>.pdf, .ppt, and .pptx</i>. Image files are also accepted, but these file types are preferred.
If you have any issues using this upload form, please <a href="mailto:<?php echo $email_to[$db_key]; ?>">contact us</a>.</p>
        ...
        <a href="presentation.php" class="btn btn-primary" role="button">Upload your Presentation</a></p>
      </div>
    </div>
...
<form role="form" id="upload" class="form-horizontal" action="submit.php?type=poster" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label for="file" class="col-sm-5 control-label">Upload your Symposium Poster</label>
    <div class="col-sm-4">
  ...
  <div class="form-group">
    <div style="text-align:center;">
      <button type="submit" name="action" value="edit" style="margin-right:10px;" class="btn btn-success">Upload Poster</button>
