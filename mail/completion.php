 ...
 * an HTML formatted version of the application
 * completeness letter.
 */
...
$subject = $pgmName . ": Application Status";
?>
...
<script type="text/javascript">
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Application Completeness <small>For <?php echo str_replace("_", " ", $record2->getField('NameFull')); ?></small></h1>
  ...
  <div class="form-group">	
   ...
   <div class="form-group">	
	<div class="col-sm-offset-2 col-sm-8">
		...
		<?php	
			echo $record->getField('LORappCompletionLetterCSS');	
 		?>
		</textarea>
	</div>
   </div>
