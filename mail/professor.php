...
$record = $fm->getRecordById('Professors', $_GET['recid']);
$record2 = $fm->getRecordById($db_layout[$db_key], $_GET['recid']);
$subject = $pgmName . ": Lab Host?";
?>
...
<script type="text/javascript">
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Email Applicants List <small>To <?php echo str_replace("_", " ", $record->getField('Professor_FullName')); ?></small></h1>
...
<form class="form-horizontal" role="form" action="submit.php?recid=<?php echo $_GET['recid']; ?>" method="post">
  ...
  <div class="form-group">	
	...
	<div class="col-sm-8">
		<input type="text" class="form-control" name="to" value="<?php echo $record->getField('Professor_Email'); ?>"></input>
	</div>
   </div>
  ...
  <div class="form-group">	
   ...
   <div class="form-group">	
	<div class="col-sm-offset-2 col-sm-8">
		...
		<?php	
			echo $record->getField('Email_URLCSS');	
 		?>
		</textarea>
	</div>
   </div>
